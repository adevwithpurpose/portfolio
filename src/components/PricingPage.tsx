...
const tiers = [
  {
    ...
    price: "$3,500",
    period: "/month",
    description: "Perfect for early-stage Shopify brands ready to automate their first workflows.",
    highlight: false,
    features: [
      "Up to 3 n8n workflow automations",
      "Shopify store integration setup",
  ...
  },
  {
    ...
    highlight: true,
    features: [
      "Up to 10 n8n workflow automations",
      "Multi-channel integrations (Shopify, Meta, WhatsApp)",
  ...
  },
  {
    ...
    highlight: false,
    features: [
      "Unlimited n8n workflow automations",
    ...
    <main className="relative min-h-screen bg-[#09090b] text-white">
      ...
      <div className="relative z-10 w-full px-6 py-16">
        ...
        <div className="mx-auto mb-16 max-w-3xl text-center">
          ...
          <h1 className="text-[clamp(2.5rem,6vw,4rem)] font-black leading-[1.1] tracking-tight text-white">
            Investment Tiers
          </h1>
