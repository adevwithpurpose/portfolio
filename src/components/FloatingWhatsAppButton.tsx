...
export default function FloatingWhatsAppButton() {
  ...
  return (
    ...
    >
      {/* Tooltip */}
      <span className="pointer-events-none absolute right-full mr-3 whitespace-nowrap rounded-md bg-zinc-900/90 px-2.5 py-1 text-xs font-medium text-white opacity-0 backdrop-blur-sm transition-opacity duration-200 group-hover:opacity-100">
        Prefer WhatsApp? Just say hi 👋
      </span>
      <svg
